...
public class Evaluate extends Prediction
{
    ...
    private int[][] testingFreqTable = this.getFrequencyOutcomes();

    private final double[] testingRulePercentage = this.getPermRulesPercentage();

    private String[] testLikelyHood = this.getAcceptedLikelyHood();
